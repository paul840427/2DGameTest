...
public class PoseModelHelper : MonoBehaviour
{
    ...
    public static readonly Dictionary<HumanBodyBones, int> bone2IndexMap = new Dictionary<HumanBodyBones, int>
    {
        ...
        {HumanBodyBones.LeftIndexProximal, 8},
        {HumanBodyBones.LeftIndexDistal, 9},
        {HumanBodyBones.LeftThumbProximal, 10},

        {HumanBodyBones.RightUpperArm, 11},
        {HumanBodyBones.RightLowerArm, 12},
        {HumanBodyBones.RightHand, 13},
        {HumanBodyBones.RightIndexProximal, 14},
        {HumanBodyBones.RightIndexDistal, 15},
        {HumanBodyBones.RightThumbProximal, 16},

        {HumanBodyBones.LeftUpperLeg, 17},
        {HumanBodyBones.LeftLowerLeg, 18},
        {HumanBodyBones.LeftFoot, 19},
        {HumanBodyBones.LeftToes, 20},

        {HumanBodyBones.RightUpperLeg, 21},
        {HumanBodyBones.RightLowerLeg, 22},
        {HumanBodyBones.RightFoot, 23},
